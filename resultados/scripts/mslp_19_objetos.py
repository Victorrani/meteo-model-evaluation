...
plt.plot(df_filtrado_F["datetime"], df_filtrado_F["AREA"]*grade1, "-o", label="Forecast v1.0.0", color='#d62828')
plt.plot(df_filtrado2_F["datetime"], df_filtrado2_F["AREA"]*grade1, "x", label="Forecast v1.1.0", color='#d62828', linestyle='--')
...
# ---------- Length ----------
plt.figure(figsize=(10,6))
plt.plot(df_filtrado_F["datetime"], df_filtrado_F["LENGTH"]*grade, "-o", label="Forecast v1.0.0", color='#d62828')
plt.plot(df_filtrado2_F["datetime"], df_filtrado2_F["LENGTH"]*grade, "x", label="Forecast v1.1.0", color='#d62828', linestyle='--')
...
# ---------- Width ----------
plt.figure(figsize=(10,6))
plt.plot(df_filtrado_F["datetime"], df_filtrado_F["WIDTH"]*grade, "-o", label="Forecast v1.0.0", color='#d62828')
plt.plot(df_filtrado2_F["datetime"], df_filtrado2_F["WIDTH"]*grade, "x", label="Forecast v1.1.0", color='#d62828', linestyle='--')
...
ax.plot(df_filtrado_F["CENTROID_LON"], df_filtrado_F["CENTROID_LAT"], 
        color='#d62828', linewidth=1, alpha=0.7, zorder=1)
...
ax.scatter(df_filtrado2_F["CENTROID_LON"], df_filtrado2_F["CENTROID_LAT"], 
           label="Forecast v1.1.0", color='#d62828', marker='x', s=20, zorder=2)
