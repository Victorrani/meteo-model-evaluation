...
limit_date = "20240216_000000"

# Filtra o DataFrame para excluir as linhas com data a partir de '20240222 18h'
df_filtrado = df_filtrado[df_filtrado["FCST_VALID"] > limit_date]
...
plt.plot(df_filtrado["datetime"], df_filtrado["INTEREST"], "o", label="v1.0.0", color='#65a1e6', linestyle='-')
plt.plot(df_filtrado2["datetime"], df_filtrado2["INTEREST"], "x", label="v1.1.0", color='#65a1e6', linestyle='--')
...
# ---------- CENTROID_DIST ----------
plt.figure(figsize=(12,5))
plt.plot(df_filtrado["datetime"], df_filtrado["CENTROID_DIST"]*grade, "o", label="v1.0.0", color='#65a1e6', linestyle='-')
plt.plot(df_filtrado2["datetime"], df_filtrado2["CENTROID_DIST"]*grade, "x", label="v1.1.0", color='#65a1e6', linestyle='--')
plt.xlabel("Time", fontsize=14, fontweight='bold')
...
# ---------- AREA_RATIO ----------
plt.figure(figsize=(12,5))
plt.plot(df_filtrado["datetime"], df_filtrado["AREA_RATIO"], "o", label="v1.0.0", color='#65a1e6', linestyle='-')
plt.plot(df_filtrado2["datetime"], df_filtrado2["AREA_RATIO"], "x", label="v1.1.0", color='#65a1e6', linestyle='--')
plt.xlabel("Time", fontsize=14, fontweight='bold')
