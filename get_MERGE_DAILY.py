...
url_base = 'https://ftp1.cptec.inpe.br/modelos/tempo/MERGE/GPM/DAILY/'

print(f'Fazendo download das imagens disponíveis no endereço:\n{url_base}\n')

# Entrada da data inicial
print('Escreva a data inicial para o início do download (formato: YYYYMMDD):')
data_inicial = input().strip()

# Entrada da data final
print('Escreva a data final para o fim do download (formato: YYYYMMDD):')
data_final = input().strip()

# Entrada do diretório de destino
print('Escreva o caminho do diretório onde os arquivos serão salvos:')
...
while data_atual <= dt_final:
    ...
    arquivo_nome = f'MERGE_CPTEC_{ano}{mes}{dia}.grib2'
    url_arquivo = f'{url_base}{ano}/{mes}/{arquivo_nome}'
    ...
    data_atual += timedelta(hours=int(24))
